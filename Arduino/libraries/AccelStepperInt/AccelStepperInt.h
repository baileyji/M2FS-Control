...
#ifndef AccelStepperInt_h
#define AccelStepperInt_h
...
/////////////////////////////////////////////////////////////////////
/// \class AccelStepperInt AccelStepperInt.h <AccelStepperInt.h>
...
public:
    ...
    /// to pin 5.
    AccelStepperInt(uint8_t pins = 4, uint8_t pin1 = 2, uint8_t pin2 = 3, uint8_t pin3 = 4, uint8_t pin4 = 5);
    ...
    AccelStepperInt(void (*forward)(), void (*backward)());
...
private:
    ...
    //http://members.chello.nl/j.beentjes3/Ruud/sqrt32avr.htm#Sqrt32R
    //Cycles incl call & ret = 271 - 316
//    static uint32_t sqrt_i_asm(uint32_t x);
};
