...
class OrientalMotor(object):
    ...
    def get_position(self):
        ...
        raw = merge_reg(self.modbus.read_holding_registers(0x00CC, 2, unit=1).registers, bytewid=2, rev=True)
    ...
    def read_alarm(self, number=1):
        ...
        return self.modbus.read_holding_registers(0x0A00, 26, unit=1).registers
